                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="md:col-span-2 md:row-span-2 bg-white rounded-xl overflow-hidden shadow-lg group relative min-h-[400px]">
                    <img 
                      ...
                      alt="Curated minimalist high fashion clothing elements flat-lay" 
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuAkKBd2Hrt1q90iX-dOP-Sf459B-ARU2UlCjBbp5Ut_Vl2w8J4Trt0bsYUlTrvl6YCkYk8IXNFVvhX-BMvXH674_l1bweOi63zKiiYjLCJX7ZtMBzyWtGDFiAF_naLl2uaSS09jiJibv0zQcSNCqOjf9y83y33HUnjS8VlDWvF7CleRC3QkAkiRvyWhnKtsMzJXtONHOgaJAPDbd98W98Vqz6_nV-5fXwFgK9Zc2VlMDCD_OOBPz8MndXCB6BPlHLC0nIugBlpgYF8"
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-purple-950/60 to-transparent flex flex-col justify-end p-8">
                      <h4 className="text-white font-serif text-2xl font-bold mb-2">Sustainable Luxury</h4>
                      <p className="text-white/80 font-sans text-sm">Consciously curated pieces that last.</p>
                    </div>
                  </div>
