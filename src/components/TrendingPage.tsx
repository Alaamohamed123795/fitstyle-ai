...
const TRENDING_LOOKS: CuratedLook[] = [
  {
    id: "look-casual-1",
    name: "Cream & Olive Silk Coordinate",
    occasion: "Casual",
    image: creamBlouseImg,
    likes: 412,
    tags: ["Silk", "Wide-Leg", "Classic"],
    topId: "prod-cas-blouse",
    bottomId: "prod-cas-trousers",
    footwearId: "",
    accessoriesId: ""
  },
  {
    id: "look-casual-2",
    name: "Retro Polka Dot Mini Look",
    occasion: "Casual",
    image: polkaDotDressImg,
    likes: 295,
    tags: ["Polka Dot", "Bustier", "A-Line"],
    topId: "prod-cas-polka-dress",
    bottomId: "",
    footwearId: "",
    accessoriesId: ""
  }
...
export default function TrendingPage({ products, currentUser, onSignInRequired, onTryOutfit }: TrendingPageProps) {
  ...
  const occasions = ["All", "Wedding", "Formal", "Casual", "Party"];

  const filteredLooks = selectedOccasion === "All" 
    ? TRENDING_LOOKS 
    : TRENDING_LOOKS.filter(look => look.occasion.toLowerCase() === selectedOccasion.toLowerCase());
