...
interface AdminDashboardProps {
  products: Product[];
  onAddProduct: (prod: Omit<Product, "id"> & { id?: string }) => void;
...
export default function AdminDashboard({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!name.trim() || !image.trim() || !colour.trim() || !price) {
            ...
            <form onSubmit={handleSubmit} className="flex-grow p-6 overflow-y-auto space-y-6">
              ...
              <div className="border-t border-slate-100 pt-5">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            ...
                            setUploadError("Photo upload failed. Please ensure Firebase Storage rules allow writing.");
                          } finally {
                            setUploading(false);
                          }
                        }}
                    ...
                    {uploading && (
                      <div className="flex items-center gap-2 text-xs text-[#5a005a] font-semibold">
                  ...
                  {image ? (
                    <div className="relative w-32 h-40 rounded-xl overflow-hidden border border-slate-200 mt-2 shadow-sm group">
                      <img src={image} alt="Garment Preview" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
              ...
              <div className="pt-6 border-t border-slate-100 flex gap-3 shrink-0">
                ...
                <button
                  type="submit"
                  disabled={uploading}
                  className="flex-grow flex-1 py-3 px-4 bg-[#5a005a] text-white rounded-xl font-outfit text-xs font-semibold uppercase tracking-widest hover:bg-[#430043] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
